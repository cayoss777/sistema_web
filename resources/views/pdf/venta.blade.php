...
<html>
    ...
    <body>
                ...
                <table id="facproducto">
                    ...
                    <tfoot>
                        ...
                        <tr>
                            ...
                            <td><p align="right">S/.{{number_format($v->total*20/100,2)}}</p></td>
                        </tr>

                        <tr>
                            <th  colspan="4"><p align="right">TOTAL PAGAR:</p></th>
                            <td><p align="right">S/.{{number_format($v->total+($v->total*20/100),2)}}</p></td>
                        </tr>
        ...
        <footer>
            ...
            <div id="datos">
                <p id="encabezado">
                    <b>Natoss Incass</b><br>Sistema Web <br>Telefono:(+51)983744950<br>Email:chuancahuire@gmail.com
                </p>
            </div>
        </footer>
    </body>
